...
- 🗂️ **当前项目目录** —— 分类入口使用当前候选目录，按方向、语言、形态与场景浏览，100 项静态分页；旧事件分类榜保留在历史归档中。目录包含尚未形成增长窗口的项目，不等于全量 GitHub 收录。
...
测试夹具由 `scripts/create-e2e-data.mjs` 在临时目录生成，包含 40 个候选日期、**1000 项历史星标榜**、2000 个候选项目页与中文 / 分类，不会进入生产数据。
